...
layui.define(["jquery", "layer"], function (f) {
    ...
    var c = "theme-admin";
    var m = {
        version: "311", defaultTheme: "theme-admin", tableName: "easyweb", flexible: function (n) {
            ...
            if (s) {
                layui.data(m.tableName, {key: "theme", value: s});
                if (c == s) {
                    s = undefined
                }
            } else {
            ...
            if (m.getPageWidth() > 750) {
                if (!o) {
                    var n = h(k + ">.layui-tab-content>.layui-tab-item.layui-show>.admin-iframe");
                    if (n.length <= 0) {
    ...
    m.events = {
        flexible: function (o) {
            ...
            n.popupRight({id: "layer-theme", type: 2, content: o ? o : "page/tpl/tpl-theme.html"})
        }, note: function () {
            var n;
            if (window != top && !m.isTop()) {
                if (top.layui && top.layui.admin) {
            ...
            var o = h(this).attr("data-url");
            n.popupRight({id: "layer-notice", type: 2, content: o ? o : "page/tpl/tpl-message.html"})
        }, psw: function () {
            var n;
            if (window != top && !m.isTop()) {
                if (top.layui && top.layui.admin) {
            ...
            var o = h(this).attr("data-url");
            n.open({id: "pswForm", type: 2, title: "修改密码", shade: 0, content: o ? o : "page/tpl/tpl-password.html"})
        }, logout: function () {
            var n = h(this).attr("data-url");
            j.confirm("确定要退出登录吗？", {title: "温馨提示", skin: "layui-layer-admin"}, function () {
    ...
    h(document).on("mouseenter", "*[lay-tips]", function () {
        ...
        var p = h(thisremoveNavHover).attr("lay-bg");
        j.tips(n, this, {tips: [o || 3, p || "#333333"], time: -1})
        ...
        if (m.getPageWidth() > 750) {
            ...
            if (q.length > 0) {
                ...
                if (o.hasClass("layui-nav-item")) {
                    ...
                    j.tips(n, o, {
                        tips: [2, "#333333"], time: -1, success: function (r, s) {
    ...
    m.chooseLocation = function (s) {
        ...
        p += "   </div>";
        m.open({
            id: "ew-map-select", type: 1, title: o, area: "750px", content: p, success: function (C, D) {
    ...
    m.cropImg = function (q) {
        ...
        layui.use(["cropper", "upload"], function () {
            ...
            function y() {
                var B = h("#ew-crop-img");
                var C = {
                    elem: "#ew-crop-img-upload", auto: false, drag: false, choose: function (D) {
                ...
                var A = {aspectRatio: v, preview: "#ew-crop-img-preview"};
                B.cropper(A);
                h(".ew-crop-tool").on("click", "[data-method]", function () {
                    var E = B.data("cropper");
                    var F = h(this).data(), G, D;
                    if (!E || !F.method) {
                        return
                    }
                    F = h.extend({}, F);
            ...
            z += "   </div>";
            m.open({
                title: n, area: "665px", type: 1, content: z, success: function (A, B) {
