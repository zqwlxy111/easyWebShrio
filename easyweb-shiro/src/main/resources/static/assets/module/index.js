...
layui.define(["layer", "element", "admin", "contextMenu"], function (s) {
    ...
    var h = {
        ...
        loadHome: function (w) {
            ...
            h.loadView({menuPath: c, menuName: w.menuName});
            if (!h.pageTabs) {
        ...
        openTab: function (w) {
            ...
            h.loadView({menuPath: u, menuName: v})
        },
        closeTab: function (u) {
            if (window != top && !m.isTop()) {
                if (top.layui && top.layui.index) {
        ...
        setTabCache: function (u) {
            ...
            layui.data(m.tableName, {key: "cacheTab", value: u});
            h.cacheTab = u;
            if (u) {
                m.putTempData("indexTabs", h.mTabList);
                m.putTempData("tabPosition", h.mTabPosition)
    ...
    b.on("nav(" + p + ")", function (x) {
        ...
        if (u && u != "javascript:;") {
            ...
            h.loadView({menuId: y, menuPath: u, menuName: v})
        }
